...
from backend.routes import product, reviewer, reviewers, rings, chat, products, overview, analyze, ring_check
import duckdb
...
app.include_router(ring_check.router, tags=["ring-check"])
