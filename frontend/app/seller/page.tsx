    ...
    <div className="min-h-screen p-6 md:p-8 max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        <div className="w-9 h-9 rounded-xl flex items-center justify-center"
          style={{ background: "rgba(255,181,71,0.2)", border: "1px solid rgba(255,181,71,0.3)" }}>
          <BarChart3 className="w-4 h-4" style={{ color: "#FFB547" }} />
        </div>
        <div>
          <h1 className="text-xl font-semibold text-white">Seller Dashboard</h1>
          <p className="text-xs" style={{ color: "rgba(255,255,255,0.4)" }}>Monitor your product&apos;s review health</p>
        </div>
      </div>
        ...
        <>
          ...
          {flaggedReviews.length > 0 && (
            <div className="p-6" style={GLASS}>
              <p className="text-sm font-medium mb-4 text-white">Flagged Reviews to Watch</p>
